...
function DisplayHome() {
  ...
  return (
    <>
      ...
      <div className="mb-4">
        <h1 className="page-header">Today's hits</h1>
      ...
      <div className="mb-4">
        <h1 className="page-header">Songs</h1>

        <div className="flex-container">
          {songsData.map((item, index) => (
            <SongItem key={index} name={item.name} image={item.image} desc={item.desc} songUrl={item.file} id={item.id} />
          ))}
        </div>
      </div>
    </>
